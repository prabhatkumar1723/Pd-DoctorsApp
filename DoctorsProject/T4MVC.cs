...
{
    public static DoctorsProject.Controllers.HomeController Home = new DoctorsProject.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static partial class Bundles
    {
        ...
        public static partial class Content 
        {
            public static class Assets
            {
                public static readonly string all_min_css = T4MVCHelpers.ProcessAssetPath("~/Content/all.min.css");
